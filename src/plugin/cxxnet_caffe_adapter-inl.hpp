...
namespace cxxnet{
    ...
    public:
        ...
        virtual void Forward( bool is_train ){
            mshadow::Shape<4> shape_in = in_.data.shape; shape_in.stride_ = shape_in[3];
            mshadow::Shape<4> shape_ou = out_.data.shape; shape_ou.stride_ = shape_ou[3];
            if( xpu::kDevCPU ){
